...
global $wp_query;
$data  = \AXTRA\Includes\Classes\Common::instance()->data( 'search' )->get();
$layout = $options->get( 'search_sidebar_layout' );
$sidebar = $options->get( 'search_page_sidebar' );
$show_banner = $options->get( 'search_page_banner' );
$bg_img = $options->get( 'search_page_background' );
$title = $options->get( 'search_banner_title' );
            ...
            <div class="row">
                ...
                <div class="content-side <?php echo esc_attr( $class ); ?>">
                	<div class="blog__list">
                        ...
                        <?php else : ?>
                            <div class="blog__sidebar pb-110">
                            	<p class="mb-4"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'axtra' ); ?></p>
								<?php get_search_form() ?>
                            </div>
                        <?php endif; ?>
