...
//Vertical Dark Color Logo Settings
...
<!-- Team Cursor -->
<div class="cursor" id="team_cursor"><?php esc_html_e('Drag', 'axtra');?></div>
...
<header class="header__area">
    <div class="header__inner">
		...
		<?php if($options->get('show_phone_no_v7')){ ?>
        <div class="header__support">
        	<p><?php echo wp_kses($options->get('phone_title_v3'), true); ?> <a href="tel:<?php echo esc_attr($options->get('phone_no_v7'), true); ?>"><?php echo wp_kses($options->get('phone_no_v7'), true); ?></a></p>
        </div>
        <?php } ?>
    </div>
</header>
