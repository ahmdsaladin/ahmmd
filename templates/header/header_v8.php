...
$logo_typography = ''; ?>
    ...
    <header class="header__area-3">
        <div class="header__inner-3">
            ...
            <?php if(($options->get('show_search_form_v8')) || ($options->get('show_sidebar_info'))){ ?>
            <div class="header__nav-icon-3">
                <?php if($options->get('show_search_form_v8')){ ?>
                ...
                <?php if($options->get('show_sidebar_info')){ ?><button id="open_offcanvas"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon/menu-black.png" alt="<?php esc_attr_e('Menubar Icon', 'axtra'); ?>"></button><?php } ?>
            </div>
            <?php } ?>
        </div>
    </header>
