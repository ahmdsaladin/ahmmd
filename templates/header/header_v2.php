...
<header class="header__area-2">
    <div class="header__inner-2">
        ...
        <div class="header__nav-icon-2">
        	<button class="menu-icon-2" id="open_offcanvas"><img class="h-22" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon/menu-white.svg" alt="<?php esc_attr_e('Menubar Icon', 'axtra'); ?>"></button>
        </div>
        <?php } ?>
    </div>
</header>
