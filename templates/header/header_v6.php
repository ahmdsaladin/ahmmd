...
<!-- Featured Work -->
<div class="cursor" id="portfolio4_cursor"><?php esc_html_e('View', 'axtra'); ?></div>
...
<header class="header__area-5">
    <div class="header__inner-5">
        ...
        <div class="header__nav-icon-5">
            <button id="open_offcanvas"><span class="menu-text-5"><?php esc_html_e('Menu', 'axtra'); ?></span><img class="h-15" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/icon/menu-line.svg" alt="<?php esc_attr_e('Menubar Icon', 'axtra'); ?>"></button>
        </div>
        <?php } ?>
    </div>
</header>
