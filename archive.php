...
get_header();
global $wp_query;
$data  = \AXTRA\Includes\Classes\Common::instance()->data( 'archive' )->get();
$layout = $options->get( 'archive_sidebar_layout' );
$sidebar = $options->get( 'archive_page_sidebar' );
$show_banner = $options->get( 'archive_page_banner' );
$bg_img = $options->get( 'archive_page_background' );
$title = $options->get( 'archive_banner_title' );
