...
global $wp_query;
$data  = \AXTRA\Includes\Classes\Common::instance()->data( 'tag' )->get();
$layout = $options->get( 'tag_sidebar_layout' );
$sidebar = $options->get( 'tag_page_sidebar' );
$show_banner = $options->get( 'tag_page_banner' );
$bg_img = $options->get( 'tag_page_background' );
$title = $options->get( 'tag_banner_title' );
